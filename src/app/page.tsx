  ...
  return (
    <main className={styles.container}>
      ...
      <section className={styles.bio}>
        <p>
          I&apos;m a software engineer at heart, tinkering with UI and code almost 90% of the time. I&apos;m mostly active on{" "}
          <Link href="https://github.com/SRAJAN-00" target="_blank" className={styles.highlight}>GitHub</Link> where I share everything.
        </p>
        <p>
          When I&apos;m not coding, I usually talk about Design Engineering, warm editorial UI aesthetics, and front-end design taste. Currently a BCA student.
        </p>
        <p>
          I&apos;ve been working as a{" "}
          <Link href="#experience" className={styles.highlight}>Frontend Intern</Link> at a language learning platform, building React + Framer Motion components. My favourite thing is to ship new features every day.
        </p>
      </section>
        ...
        <div className={styles.list}>
          <Link href="#" className={styles.listItem}>
            ...
            <div className={styles.itemBody}>
              ...
              <span className={styles.itemDesc}>Android geofencing sound profile management app.</span>
            </div>
            <div className={styles.stackTags}>
              <span className={styles.stackTag}><span className={styles.stackIcon}>📱</span><span className={styles.stackText}>Android</span></span>
              <span className={styles.stackTag}><span className={styles.stackIcon}>☕</span><span className={styles.stackText}>Java</span></span>
            </div>
          </Link>
          ...
          <Link href="https://exdraww.vercel.app/" target="_blank" className={styles.listItem}>
            ...
            <div className={styles.itemBody}>
              ...
              <span className={styles.dot}>·</span>
              <span className={styles.itemDesc}>Collaborative drawing board.</span>
            </div>
            <div className={styles.stackTags}>
              <span className={styles.stackTag}><span className={styles.stackIcon}>⚛️</span><span className={styles.stackText}>React</span></span>
              <span className={styles.stackTag}><span className={styles.stackIcon}>💨</span><span className={styles.stackText}>Tailwind</span></span>
            </div>
          </Link>
          ...
          <Link href="https://rentalbook-three.vercel.app/" target="_blank" className={styles.listItem}>
            ...
            <div className={styles.itemBody}>
              ...
              <span className={styles.dot}>·</span>
              <span className={styles.itemDesc}>Digital library for renting books.</span>
            </div>
            <div className={styles.stackTags}>
              <span className={styles.stackTag}><span className={styles.stackIcon}>▲</span><span className={styles.stackText}>Next.js</span></span>
              <span className={styles.stackTag}><span className={styles.stackIcon}>◆</span><span className={styles.stackText}>Prisma</span></span>
            </div>
          </Link>
          ...
          <Link href="https://brain-1.vercel.app/" target="_blank" className={styles.listItem}>
            ...
            <div className={styles.itemBody}>
              ...
              <span className={styles.dot}>·</span>
              <span className={styles.itemDesc}>Knowledge base & notes app.</span>
            </div>
            <div className={styles.stackTags}>
              <span className={styles.stackTag}><span className={styles.stackIcon}>⚡</span><span className={styles.stackText}>Vite</span></span>
              <span className={styles.stackTag}><span className={styles.stackIcon}>⚛️</span><span className={styles.stackText}>React</span></span>
            </div>
          </Link>
        ...
        <div className={styles.gridList}>
          ...
          <div className={styles.gridItem}>
            ...
            <p className={styles.gridItemDesc}>
              Design Engineering Intern. Building components with React, Tailwind CSS, and Framer Motion.
            </p>
          </div>
